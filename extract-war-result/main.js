!(function(t) {
    ...
    function(t, e, r) {
        ...
        function j() {
            return (j = c()(
                o.a.mark(function t(e) {
                    var r, n, a, c, i, u, l, s, f, p, d, v, y, g, m;
                    return o.a.wrap(function(t) {
                        for (;;)
                            switch ((t.prev = t.next)) {
                                case 0:
                            ...
                            for (;;)
                                switch ((t.prev = t.next)) {
                                    ...
                                    case 11:
                                        ...
                                        return (h = f.value), (t.next = 15), p(1500);
                                    case 15:
                                        return (t.next = 17), S(h);
                                    case 17:
                                        return (d = t.sent), (t.next = 20), p(1500);
                                    case 20:
                                        if (e !== i) {
                                            t.next = 26;
                                            break;
