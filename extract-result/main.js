!(function(t) {
    ...
    function(t, e, r) {
        ...
        var n = r(0),
            ...
            l = r(2),
            s = r.n(l);
        var f = 60 * new Date().getTimezoneOffset() * 1e3;
        function p() {
                ...
                o.a.mark(function t() {
                    ...
                    return o.a.wrap(function(t) {
                        for (;;)
                            switch ((t.prev = t.next)) {
                                case 0:
                                    return (t.next = 2), d('/ratings/guild/war/');
                                case 2:
                ...
                o.a.mark(function t() {
                    ...
                    return o.a.wrap(function(t) {
                        for (;;)
                            switch ((t.prev = t.next)) {
                                case 0:
                                    return (t.next = 2), d('/guild/graids/tweens/');
                                case 2:
        ...
        function w() {
            return (w = c()(
                o.a.mark(function t() {
                    var e, r, n, a, c, i, u, l, f;
                    return o.a.wrap(function(t) {
                        for (;;)
                            switch ((t.prev = t.next)) {
                                case 0:
                                    return (t.next = 2), d('/guild/card/');
                                case 2:
                                    if (
                                        ((e = t.sent),
        ...
        function _() {
            return (_ = c()(
                o.a.mark(function t(e) {
                    var r, n, a, c, i, u, l, s, f, p, h, v, y, g, m;
                    return o.a.wrap(function(t) {
                        for (;;)
                            switch ((t.prev = t.next)) {
                                case 0:
                                    return (t.next = 2), d('/user/'.concat(e, '/'));
                                case 2:
                                    if (
                                        ((r = t.sent),
                                        '#gameBody',
                                        ...
                                        (c = r.querySelector(''.concat(n, ' > .c_99'))),
                                        (i = r.querySelector(''.concat(n, ' > .pt2.small > .fl'))),
                                        (u =
                                        ...
                                        (s = r.querySelector('.brd.fl.mr8.ml5.mb5 img')) && a && c && i && u && l)
                                    ) {
                                        t.next = 15;
                                        break;
                                    }
                                    return (
                                        console.error('getManDataById: can not get nodes, id:', e, s, a, c, i, u, l),
                                        t.abrupt('return', null)
                                    );
                                case 15:
                                    if (
                                        ...
                                        (h = parseInt(c.textContent.replace(/\D/g, ''), 10)),
                                        (v = i.textContent.trim()),
                                        (y = parseInt(u.textContent.replace(/\D/g, ''), 10)),
                ...
                o.a.mark(function t(e) {
                    ...
                    return o.a.wrap(function(t) {
                        for (;;)
                            switch ((t.prev = t.next)) {
                                case 0:
                                    return (t.next = 2), d('/gwprofile/'.concat(e, '/'));
                                case 2:
                                    if (((r = t.sent), (n = r.querySelector('.c_orange.mt10.cntr.small')))) {
                                        t.next = 7;
                                        break;
                                    }
                                    return console.error('getManWarDataById: can not get '), t.abrupt('return', null);
                                case 7:
                                    if ((a = parseInt(n.textContent.replace(/\D/g, ''), 10))) {
                                        t.next = 12;
                                        break;
                                    }
                                    return (
                                        console.error('getManDataById: can not got deckValue, id:', e),
                                        console.log(a),
                                        t.abrupt('return', null)
                                    );
                                case 12:
                                    return t.abrupt('return', {deckValue: a});
                                case 13:
                                case 'end':
                                    return t.stop();
                            }
                            ...
                            switch ((t.prev = t.next)) {
                                case 0:
                                    return (
                                        ...
                                        Promise.all(
                                            [1].map(function(t) {
                                                return d('/guild/members/page_' + t);
                                            }),
                                        )
                                    );
                                case 2:
                            ...
                            for (;;)
                                switch ((t.prev = t.next)) {
                                    ...
                                    case 11:
                                        ...
                                        return (p = f.value), (t.next = 15), h(1500);
                                    case 15:
                                        return (t.next = 17), j(p);
                                    case 17:
                                        return (d = t.sent), (t.next = 20), h(1500);
                                    case 20:
                                        if (e !== u) {
                                            t.next = 26;
                                            break;
                                        }
                                        return (t.next = 23), E(p);
                                    case 23:
                                    ...
                                    case 33:
                                        ...
                                        break;
                                    case 35:
                                        (t.prev = 35), (t.t1 = t.catch(9)), (i = !0), (l = t.t1);
                                    case 39:
                                        (t.prev = 39), (t.prev = 40), c || null == s.return || s.return();
                                    case 42:
                                        if (((t.prev = 42), !i)) {
                                            t.next = 45;
                                            break;
                        ...
                        for (;;)
                            switch ((t.prev = t.next)) {
                                case 0:
                                    return (t.next = 2), y();
                                case 2:
                                    return (r = t.sent), console.log('guildLevel:', r), (t.next = 6), m();
                                case 6:
